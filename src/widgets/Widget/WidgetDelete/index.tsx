...
interface WidgetDeleteProps {
  id: number;
  name: string
}

const WidgetDelete:React.FC<WidgetDeleteProps> = ({name, id}) => {
      ...
      {isModalOpen && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="bg-white p-6 rounded-md">
            <h2 className="text-2xl font-bold mb-4">Вы точно хотите удалить виджет {name}</h2>
